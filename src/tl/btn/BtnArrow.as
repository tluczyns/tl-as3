package tl.btn {
	...
	public class BtnArrow extends BtnHitAndBlockWithEvents {
		...
		public function BtnArrow(isPrevNext: uint, isMoveXOrY: uint = 0, arrow: DisplayObject = null, moveXYArrow: Number = 3, countFramesAnimArrow: Number = 5, hit: Sprite = null): void {
		...
		override public function createGenericHit(rectDimension: Rectangle = null): Sprite {
			...
			hit.graphics.drawRect(0, 0, this.arrow.x + this.arrow.width + [this.moveXYArrow, 0][this.isMoveXOrY], this.arrow.y + this.arrow.height + [0, this.moveXYArrow][this.isMoveXOrY]);
		...
		private function animArrow(): void {
			...
			TweenLite.to(this.arrow, this.countFramesAnimArrow, objTween);
		}
